...
# NXOLand Backend Deployment Script - Simple Version
# This script avoids sudo issues by using minimal permissions

set -e  # Exit on any error

echo "🚀 Starting NXOLand Backend Deployment (Simple Version)..."
